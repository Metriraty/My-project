...

{
    ...
    void ComboAttacks()
    {
        if (Input.GetKeyDown(KeyCode.Z))
        {
            ...
            if (current_Combo_State == ComboState.Punch_1) {player_Anim.Punch_1();}
            if (current_Combo_State == ComboState.Punch_2) { player_Anim.Punch_2(); }
            if (current_Combo_State == ComboState.Punch_3) { player_Anim.Punch_3(); }
        }
